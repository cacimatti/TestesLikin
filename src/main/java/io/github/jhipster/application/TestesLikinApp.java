...
public class TestesLikinApp {

    private static final Logger log = LoggerFactory.getLogger(TestesLikinApp.class);

    private final Environment env;

    public TestesLikinApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TestesLikin.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestesLikinApp.class);
